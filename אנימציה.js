...
lib.ssMetadata = [
		{name:"אנימציה_atlas_1", frames: [[0,0,491,814],[983,0,483,814],[493,0,488,814],[218,1137,276,79],[1050,996,224,184],[0,1137,216,118],[1050,816,295,178],[0,816,1048,319]]}
];
...
(lib.CachedBmp_8 = function() {
	this.initialize(ss["אנימציה_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AEejIQBXBVAABzQAAAegGAbQgTBdhVBGQgqAkhbAoQgjAQhfAAQiaAAhthcQgYgUgTgWIEyiyIFvA5AirkVQBNgiBeAAQCbAABsBbQAMAKALAKAlug3QATheBUhHQArgjAxgWICrEVIEejIAAAAAICCEoAkyCyQhChOAAhkQAAgcAGgbIFuA3");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AmLGMQikikAAjoQAAjnCkikQCkikDnAAQDoAACkCkQCkCkAADnQAADoikCkQikCkjoAAQjnAAikikg");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(1,1,1).p("");
	this.shape_1.setTransform(-4.5,-43.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_2.setTransform(-0.0164,9.6888);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(255,153,51,0.498)").s().p("AisCKQgZgBgcgQQgbgRgOgUQgPgVAOgMQAOgLAaAWQAaAWAXgBQAVgBANAQQANAQgIAOQgGALgUAAIgHgBgADTAPQgPgKAQghQAQgigHgWQgHgWAOgSQAMgRAPAEQAOADAEAbQAFAagJAiQgJAhgRATQgLAOgLAAQgFAAgFgEg");
	this.shape_3.setTransform(-1.6296,75.5516);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF0000").s().p("");
	this.shape_4.setTransform(-5.7375,26.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_5.setTransform(-0.0164,-21.1566);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgMAAIAAgCIAAgCIAEgEIADgCQAFgCADAAIADABIACABIAEAEIABACIABADQgBAEgCAHIgQACQgGgGgBgGg");
	this.shape_6.setTransform(-18.4,-40.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(-4.5,-43.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF6699").s().p("AAUAlIgEAAIgOAAIgQgEIgTgIIgNgHIgDgCIgEgFQgEgGgCgGQgBgOAHgJQAHgLANgBIACAAQANgCALAIIAHAEQAGADAMABIADACIAHABIAMgBQAJADAGAJQAGAIgBAJQAAAJgHAIQgGAIgKACQgDABgMAAIgCAAg");
	this.shape_8.setTransform(8.1387,-70.5375);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFF66").s().p("");
	this.shape_9.setTransform(11.175,-65.2753);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_2.setTransform(-0.2453,9.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(255,153,51,0.498)").s().p("AC3BzQgYgLAGgRQAHgRAkAGQAlAGAUgMQATgMAVAIQAUAIAAAPQAAAPgZALQgYALgiAAQgjAAgYgLgAkmADQgRgSgIgfQgIgfAEgYQAFgaASACQASACADAiQADAiAQAPQAQAPgCAUQgDAUgOAEIgFAAQgMAAgOgQg");
	this.shape_3.setTransform(-9.881,74.0177);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF0000").s().p("");
	this.shape_4.setTransform(-6.2375,29.75);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_5.setTransform(-0.2453,-17.8744);
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(-5,-40.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF6699").s().p("AAUAlIgEAAIgOAAIgQgEIgTgIIgNgHIgDgCIgEgFQgEgGgCgGQgBgOAHgJQAHgLANgBIACAAQANgCALAIIAHAEQAGADAMABIADACIAHABIAMgBQAJADAGAJQAGAIgBAJQAAAJgHAIQgGAIgKACQgDABgMAAIgCAAg");
	this.shape_8.setTransform(7.6387,-67.6875);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFF66").s().p("");
	this.shape_9.setTransform(10.675,-62.4253);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_2.setTransform(-0.0031,9.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(255,153,51,0.498)").s().p("AC3BzQgYgLAGgRQAHgRAkAGQAlAGAUgMQATgMAVAIQAUAIAAAPQAAAPgZALQgYALgiAAQgjAAgYgLgAkmADQgRgSgIgfQgIgfAEgYQAFgaASACQASACADAiQADAiAQAPQAQAPgCAUQgDAUgOAEIgFAAQgMAAgOgQg");
	this.shape_3.setTransform(-9.231,74.0177);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF0000").s().p("");
	this.shape_4.setTransform(-5.5875,29.75);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgNAAIAAgCIABgCIAEgFIADgBQAFgCACAAIAEABIACABIADAEIACACIAAADQABAFgDAGIgRADQgEgIgDgFg");
	this.shape_5.setTransform(-18.25,-37.35);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_6.setTransform(-0.0031,-18.0329);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(-4.35,-40.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF6699").s().p("AAUAlIgEAAIgOAAIgQgEIgTgIIgNgHIgDgCIgEgFQgEgGgCgGQgBgOAHgJQAHgLANgBIACAAQANgCALAIIAHAEQAGADAMABIADACIAHABIAMgBQAJADAGAJQAGAIgBAJQAAAJgHAIQgGAIgKACQgDABgMAAIgCAAg");
	this.shape_8.setTransform(8.2887,-67.6875);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFF66").s().p("");
	this.shape_9.setTransform(11.325,-62.4253);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF99").ss(1,1,1).p("EgGQgjKIAZgEIABAIQC2ApDoIpQEEJsCvOMQADASAEASQCvOjgQKuQgLHfhlCjQgsBHg7ALQg8ALhDgyQiZhyi4m6QkKp5iwukQgVhugShrQiIscAPpbQAOqFCxhIgEgHBgjAQAMgFANgDQAMgBAMgBEgF2gjGMANOBF+IhJAPMgNQhGH");
	this.shape.setTransform(64.2421,225.4992);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#66CC33").s().p("EAErAimQiZhyi4m6QkKp5iwukQgVhugShrQiIscAPpbQAOqFCxhIMANQBGHIBJgPMgNOhF+QC2ApDoIpQEEJsCvOMIAHAkQCvOjgQKuQgLHfhlCjQgsBHg7ALQgLACgLAAQgzAAg2gpgEgHBgjAIAxgKIAZgEIABAIMANOBF+IhJAPgEgHBgjAQAMgFANgDIAYgCIgxAKg");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AnAHBQi6i6AAkHQAAkGC6i7QC6i6EGAAQEHAAC6C6QC7C7gBEGQABEHi7C6Qi6C7kHAAQkGAAi6i7g");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,153,255,0.498)").s().p("");
	this.shape_2.setTransform(62.8,191.2625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#999999").s().p("");
	this.shape_3.setTransform(62.1896,147.1714);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000099").s().p("");
	this.shape_4.setTransform(61.135,111.6663);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_5.setTransform(54.7099,87.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#66FF66").s().p("");
	this.shape_6.setTransform(58.0411,97.6813);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(57.3813,21.7375);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,153,255,0.498)").s().p("");
	this.shape_2.setTransform(61.75,191.2625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#999999").s().p("");
	this.shape_3.setTransform(61.1396,147.1714);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000099").s().p("");
	this.shape_4.setTransform(60.085,111.6663);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_5.setTransform(54.1957,87.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#66FF66").s().p("");
	this.shape_6.setTransform(56.9911,97.6813);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(56.3313,21.7375);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,153,255,0.498)").s().p("");
	this.shape_2.setTransform(62.5,191.2625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#999999").s().p("");
	this.shape_3.setTransform(61.8896,147.1714);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000099").s().p("");
	this.shape_4.setTransform(60.835,111.6663);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(255,51,51,0.2)").s().p("");
	this.shape_5.setTransform(54.5761,87.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#66FF66").s().p("");
	this.shape_6.setTransform(57.7411,97.6813);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(57.0813,21.7367);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-0.5,-0.45,0.2236,0.2236);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol13, new cjs.Rectangle(-0.5,-0.4,109.8,182), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol12, new cjs.Rectangle(-0.5,-0.4,108,182), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol11, new cjs.Rectangle(-0.5,-0.4,109.1,182), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF9900").ss(1,1,1).p("EgHHgt6QApALAsAhQCBBjCVExQBFCOBIC5QE7MqDVShQAFAXAEAYQDVTAgTOAQgOJwh6DVQg2BdhIAPQgaAFgbgFQgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsUQANqgCMjEQASgYAUgSQATgRAWgJMAQHBbiIBZgTg");
	this.shape.setTransform(78.1383,293.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiPgWiNQilwOATsTQANqhCMjEQASgYAUgRQATgSAWgJMAQHBbiIBZgTMgQFhbXQApALAsAhQCBBjCVExQBFCOBIC5QE7MqDVShIAJAvQDVTAgTOAQgOJwh6DVQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_1.setTransform(78.1383,293.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF9900").ss(1,1,1).p("AsK/KQANqgCMjEQASgZAUgRQATgRAWgJMAQHBbiIBZgTMgQFhbXQAqAKArAiQCBBjCVExQBFCOBIC5QE7MqDVShQAFAXAEAYQDVTAgTOAQgOJwh6DVQg2BdhIAPQgaAFgbgFQgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsUg");
	this.shape_2.setTransform(78.1383,295.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiRgWiMQilwOATsUQANqgCMjDQASgaAUgRQATgRAWgJMAQHBbhIBZgTMgQFhbWQAqAKArAiQCBBkCVEwQBFCOBIC5QE7MqDVShIAJAvQDVS/gTOBQgOJxh6DUQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_3.setTransform(78.1383,295.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsTQANqhCMjDQASgaAUgQQATgRAWgKMAQHBbiIBZgTMgQFhbXQAqALArAhQCBBkCVExQBFCNBIC5QE7MrDVSgIAJAvQDVTAgTOAQgOJxh6DUQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_4.setTransform(78.1383,297.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiRgWiMQilwOATsUQANqfCMjEQASgaAUgRQATgRAWgJMAQHBbhIBZgTMgQFhbWQAqAKArAiQCBBkCVEwQBFCOBIC6QE7MqDVSgIAJAvQDVS/gTOBQgOJwh6DVQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_5.setTransform(78.1383,298.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#FF9900").ss(1,1,1).p("AsK/KQANqgCMjEQASgZAUgRQATgRAWgJMAQHBbiIBZgTMgQFhbWQAqAKArAhQCBBkCVEwQBFCOBIC6QE7MqDVSgQAFAYAEAXQDVTAgTOAQgOJxh6DUQg2BdhIAPQgaAFgbgFQgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsUg");
	this.shape_6.setTransform(78.1383,300.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsTQANqgCMjFQASgZAUgQQATgSAWgJMAQHBbiIBZgUMgQFhbVQAqAKArAhQCBBjCVEyQBFCNBIC6QE7MpDVShIAJAvQDVTAgTOAQgOJwh6DVQg2BdhIAPQgNACgOAAQgNAAgNgCg");
	this.shape_7.setTransform(78.1383,300.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FF9900").ss(1,1,1).p("AsK/KQANqgCMjEQASgZAUgRQATgRAWgJMAQHBbhIBZgTMgQFhbWQAqAKArAiQCBBjCVExQBFCOBIC5QE7MqDVShQAFAXAEAYQDVTAgTOAQgOJxh6DUQg2BdhIAPQgaAFgbgFQgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsUg");
	this.shape_8.setTransform(78.1383,302.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsUQANqgCMjDQASgaAUgQQATgRAWgKMAQHBbiIBZgTMgQFhbXQAqALArAhQCBBjCVEyQBFCNBIC5QE7MrDVSgIAJAvQDVTAgTOAQgOJxh6DUQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_9.setTransform(78.1383,302.05);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiPgWiNQilwOATsTQANqgCMjFQASgZAUgQQATgSAWgJMAQHBbiIBZgTMgQFhbWQAqAKArAhQCBBkCVExQBFCNBIC5QE7MqDVShIAJAvQDVS/gTOBQgOJwh6DVQg2BdhIAPQgNACgOAAQgNAAgNgCg");
	this.shape_10.setTransform(78.1383,303.65);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsUQANqgCMjDQASgaAUgRQATgRAWgJMAQHBbhIBZgSMgQFhbXQAqAKArAiQCBBjCVExQBFCOBIC5QE7MrDVSgIAJAvQDVTAgTOAQgOJxh6DUQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_11.setTransform(78.1383,305.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#FF9900").ss(1,1,1).p("AsK/KQANqgCMjEQASgZAUgRQATgRAWgJMAQHBbiIBZgUMgQFhbVQAqAKArAhQCBBjCVExQBFCOBIC5QE7MqDVShQAFAXAEAYQDVTAgTOAQgOJxh6DUQg2BdhIAPQgaAFgbgFQgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsUg");
	this.shape_12.setTransform(78.1383,306.95);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiRgWiMQilwOATsUQANqfCMjFQASgYAUgSQATgQAWgKMAQHBbhIBZgTMgQFhbVQAqAJArAiQCBBkCVEwQBFCOBIC6QE7MqDVSgIAJAvQDVS/gTOBQgOJwh6DVQg2BdhIAPQgNACgOAAQgNAAgNgCg");
	this.shape_13.setTransform(78.1383,306.95);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiPgWiNQilwOATsTQANqgCMjFQASgZAUgQQATgSAWgJMAQHBbiIBZgTMgQFhbWQAqAKArAhQCBBkCVExQBFCNBIC5QE7MqDVShIAJAvQDVTAgTOAQgOJwh6DVQg2BdhIAPQgNACgOAAQgNAAgNgCg");
	this.shape_14.setTransform(78.1383,308.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsTQANqgCMjFQASgYAUgSQATgQAWgKMAQHBbhIBZgTMgQFhbVQAqAJArAiQCBBjCVExQBFCOBIC6QE7MpDVShIAJAvQDVS/gTOBQgOJwh6DVQg2BdhIAPQgNACgOAAQgNAAgNgCg");
	this.shape_15.setTransform(78.1383,310.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#FF9900").ss(1,1,1).p("EgHHgt6QAqAKArAiQCBBjCVExQBFCOBIC5QE7MqDVShQAFAXAEAYQDVTAgTOAQgOJwh6DVQg2BdhIAPQgaAFgbgFQgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsUQANqgCMjEQASgZAUgRQATgRAWgJMAQHBbiIBZgTg");
	this.shape_16.setTransform(78.1383,311.85);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiPgWiNQilwOATsTQANqgCMjFQASgYAUgRQATgRAWgKMAQHBbiIBZgTMgQFhbXQAqALArAhQCBBkCVExQBFCNBIC5QE7MqDVShIAJAvQDVTAgTOAQgOJwh6DVQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_17.setTransform(78.1383,311.85);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiQgWiMQilwOATsUQANqfCMjFQASgYAUgSQATgQAWgKMAQHBbhIBZgTMgQFhbVQAqAJArAiQCBBkCVEwQBFCOBIC6QE7MqDVSgIAJAvQDVS/gTOBQgOJwh6DVQg2BdhIAPQgNACgOAAQgNAAgNgCg");
	this.shape_18.setTransform(78.1383,306.05);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsUQANqgCMjDQASgaAUgQQATgSAWgJMAQHBbhIBZgSMgQFhbXQAqAKArAiQCBBjCVExQBFCOBIC5QE7MrDVSgIAJAvQDVTAgTOAQgOJxh6DUQg2BdhIAPQgNACgOABQgNgBgNgCg");
	this.shape_19.setTransform(78.1383,295.85);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiRgWiMQilwOATsUQANqgCMjDQASgaAUgRQATgRAWgJMAQHBbhIBZgSMgQFhbXQAqAKArAiQCBBkCVEwQBFCOBIC5QE7MqDVShIAJAvQDVS/gTOBQgOJxh6DUQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_20.setTransform(78.1383,307.65);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzAQgaiQgWiNQilwOATsUQANqgCMjDQASgaAUgRQATgRAWgJMAQHBbhIBZgSMgQFhbXQAqAKArAiQCBBjCVExQBFCOBIC5QE7MrDVSgIAJAvQDVTAgTOAQgOJxh6DUQg2BdhIAPQgNACgOABQgNgBgNgCg");
	this.shape_21.setTransform(78.1383,304.85);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFCC66").s().p("EAHRAt4QgxgJg1gqQi6iVjgpBQlDs6jWzBQgaiPgWiNQilwOATsTQANqgCMjFQASgYAUgRQATgRAWgKMAQHBbiIBZgTMgQFhbWQAqAKArAhQCBBkCVExQBFCNBIC5QE7MqDVShIAJAvQDVTAgTOAQgOJwh6DVQg2BdhIAPQgNADgOAAQgNAAgNgDg");
	this.shape_22.setTransform(78.1383,299.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_3,p:{y:295.5}},{t:this.shape_2,p:{y:295.5}}]},1).to({state:[{t:this.shape_4},{t:this.shape_2,p:{y:297.1}}]},1).to({state:[{t:this.shape_5,p:{y:298.75}},{t:this.shape_2,p:{y:298.75}}]},1).to({state:[{t:this.shape_7,p:{y:300.4}},{t:this.shape_6,p:{y:300.4}}]},1).to({state:[{t:this.shape_9},{t:this.shape_8,p:{y:302.05}}]},1).to({state:[{t:this.shape_10,p:{y:303.65}},{t:this.shape_6,p:{y:303.65}}]},1).to({state:[{t:this.shape_11},{t:this.shape_8,p:{y:305.3}}]},1).to({state:[{t:this.shape_13,p:{y:306.95}},{t:this.shape_12,p:{y:306.95}}]},1).to({state:[{t:this.shape_14},{t:this.shape_2,p:{y:308.6}}]},1).to({state:[{t:this.shape_15,p:{y:310.2}},{t:this.shape_12,p:{y:310.2}}]},1).to({state:[{t:this.shape_17},{t:this.shape_16,p:{y:311.85}}]},1).to({state:[{t:this.shape_10,p:{y:310.4}},{t:this.shape_6,p:{y:310.4}}]},1).to({state:[{t:this.shape_7,p:{y:308.95}},{t:this.shape_12,p:{y:308.95}}]},1).to({state:[{t:this.shape_15,p:{y:307.5}},{t:this.shape_2,p:{y:307.5}}]},1).to({state:[{t:this.shape_18,p:{y:306.05}},{t:this.shape_8,p:{y:306.05}}]},1).to({state:[{t:this.shape_5,p:{y:304.6}},{t:this.shape_2,p:{y:304.6}}]},1).to({state:[{t:this.shape_7,p:{y:303.1}},{t:this.shape_2,p:{y:303.1}}]},1).to({state:[{t:this.shape_15,p:{y:301.65}},{t:this.shape_6,p:{y:301.65}}]},1).to({state:[{t:this.shape_13,p:{y:300.2}},{t:this.shape_12,p:{y:300.2}}]},1).to({state:[{t:this.shape_5,p:{y:298.75}},{t:this.shape_2,p:{y:298.75}}]},1).to({state:[{t:this.shape_3,p:{y:297.3}},{t:this.shape_8,p:{y:297.3}}]},1).to({state:[{t:this.shape_19},{t:this.shape_16,p:{y:295.85}}]},1).to({state:[{t:this.shape_3,p:{y:297.3}},{t:this.shape_8,p:{y:297.3}}]},1).to({state:[{t:this.shape_5,p:{y:298.75}},{t:this.shape_2,p:{y:298.75}}]},1).to({state:[{t:this.shape_13,p:{y:300.2}},{t:this.shape_12,p:{y:300.2}}]},1).to({state:[{t:this.shape_15,p:{y:301.65}},{t:this.shape_6,p:{y:301.65}}]},1).to({state:[{t:this.shape_7,p:{y:303.1}},{t:this.shape_2,p:{y:303.1}}]},1).to({state:[{t:this.shape_5,p:{y:304.6}},{t:this.shape_2,p:{y:304.6}}]},1).to({state:[{t:this.shape_18,p:{y:306.05}},{t:this.shape_8,p:{y:306.05}}]},1).to({state:[{t:this.shape_15,p:{y:307.5}},{t:this.shape_2,p:{y:307.5}}]},1).to({state:[{t:this.shape_7,p:{y:308.95}},{t:this.shape_12,p:{y:308.95}}]},1).to({state:[{t:this.shape_10,p:{y:310.4}},{t:this.shape_6,p:{y:310.4}}]},1).to({state:[{t:this.shape_17},{t:this.shape_16,p:{y:311.85}}]},1).to({state:[{t:this.shape_5,p:{y:310.45}},{t:this.shape_12,p:{y:310.45}}]},1).to({state:[{t:this.shape_10,p:{y:309.05}},{t:this.shape_8,p:{y:309.05}}]},1).to({state:[{t:this.shape_20},{t:this.shape_6,p:{y:307.65}}]},1).to({state:[{t:this.shape_7,p:{y:306.25}},{t:this.shape_2,p:{y:306.25}}]},1).to({state:[{t:this.shape_21},{t:this.shape_2,p:{y:304.85}}]},1).to({state:[{t:this.shape_15,p:{y:303.45}},{t:this.shape_12,p:{y:303.45}}]},1).to({state:[{t:this.shape_9},{t:this.shape_8,p:{y:302.05}}]},1).to({state:[{t:this.shape_18,p:{y:300.65}},{t:this.shape_6,p:{y:300.65}}]},1).to({state:[{t:this.shape_22},{t:this.shape_2,p:{y:299.25}}]},1).to({state:[{t:this.shape_5,p:{y:297.85}},{t:this.shape_16,p:{y:297.85}}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1,-1,158.3,607.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,7.9,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_4();
	this.instance_1.setTransform(14.5,-0.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.start, new cjs.Rectangle(0,-0.5,138,92), null);
...
if (reversed == null) { reversed = false; }
	...
	// grass
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#009933").ss(1,1,1).p("EhkQgOMQP/CNMyHHQegvnV/KuQZls1YaBgQTrBGQoLmQWjmjKcAxMAAAAjdMjIhAAAg");
	this.shape.setTransform(638.7,584.0218);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#009933").s().p("EhkQAVRMAAAgjdQP/CNMyHHQegvnV/KuQZls1YaBgQTrBGQoLmQWjmjKbAxMAAAAjdg");
	this.shape_1.setTransform(638.7,584.0218);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape}]},1).wait(137));
...
(lib.ילדה = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance}]},4).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},6).wait(4));
...
(lib.ילד = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:true},1).wait(7).to({_off:false},0).wait(3).to({_off:true},1).wait(7));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(1).to({regX:53.5,x:54.95},0).wait(1).to({_off:true},1).wait(8).to({_off:false,x:54.65},0).wait(2).to({_off:true},1).wait(4));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},0).wait(3).to({_off:true},1).wait(7).to({_off:false},0).wait(4));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.1,-0.4,110.1,182);
...
(lib.פרח = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.גלשן = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.גלשן, new cjs.Rectangle(-0.5,-0.5,129.5,452), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.שמש("synched",14);
	this.instance.setTransform(0.15,0.05,1,1,87.6423,0,0,132.1,129.9);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF33").ss(6,1,1).p("AAXIvQjnAKiridQiqidgKjoQgJjmCdirQCdiqDogLQDmgJCsCeQCqCdAKDnQAJDnidCrQidCqjoAJg");
	this.shape.setTransform(4.6,-3.2944);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Al6GcQiridgJjoQgKjmCdirQCdiqDogLQDngJCqCeQCqCdAKDnQAKDnidCrQidCqjoAJIgbABQjWAAigiUg");
	this.shape_1.setTransform(4.6,-3.2944);
...
p.nominalBounds = new cjs.Rectangle(-131.7,-141.2,269.4,276.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.שמש("synched",7);
	this.instance.setTransform(0.25,-0.05,1,1,53.4455,0,0,132.1,130);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF33").ss(6,1,1).p("AFNHBQi6CLjkgiQjlgiiLi7QiKi6AijkQAijmC6iKQC7iKDlAiQDlAiCKC6QCKC7giDkQgiDli7CKg");
	this.shape.setTransform(2.199,-5.2349);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhRIqQjlgiiLi7QiKi6AijkQAijmC6iKQC7iKDlAiQDlAiCKC6QCKC7giDkQgiDli7CKQiVBwiyAAQgqAAgtgHg");
	this.shape_1.setTransform(2.199,-5.2349);
...
p.nominalBounds = new cjs.Rectangle(-133.3,-135.4,269.6,268.20000000000005);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.שמש("synched",0);
	this.instance.setTransform(0.05,-0.05,1,1,0,0,0,132.1,130.1);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF33").ss(6,1,1).p("AIwAAQAADoikCkQikCkjoAAQjnAAikikQikikAAjoQAAjnCkikQCkikDnAAQDoAACkCkQCkCkAADng");
	this.shape.setTransform(-3,-4.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AmLGMQikikAAjoQAAjnCkikQCkikDnAAQDoAACkCkQCkCkAADnQAADoikCkQikCkjoAAQjnAAikikg");
	this.shape_1.setTransform(-3,-4.75);
...
p.nominalBounds = new cjs.Rectangle(-135,-133.1,270.1,266.29999999999995);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(-0.05,-3.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-0.2,y:0.1},7).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},7).to({_off:true,x:-0.05,y:-3.9},7).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-135.2,-145.1,272.9,278.4);
...
if (reversed == null) { reversed = false; }
	...
	// wheels2
	this.instance = new lib.wheelright();
	this.instance.setTransform(1265.3,524.15,1,1,0,0,0,31.9,28.3);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(292).to({_off:false},0).to({regX:31.8,regY:28.4,rotation:-59.9996,x:1191.3,y:526.15},16).to({regX:31.7,rotation:-119.9989,x:1104.45,y:528.2},15).to({regY:28.3,rotation:-164.9985,x:1028.4},19).to({regY:28.2,scaleX:0.9999,scaleY:0.9999,rotation:-209.9978,x:950.45,y:528.35},17).wait(31));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1241.85,377.95);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(453).to({_off:false},0).to({_off:true,x:1123,y:376.3},13).wait(64));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(453).to({_off:false},13).to({_off:true,x:981.85,y:374.1},10).wait(54));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(466).to({_off:false},10).to({_off:true,x:846.55,y:373.75},15).wait(39));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(476).to({_off:false},15).to({_off:true,x:744.45,y:376.35},14).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(491).to({_off:false},14).to({startPosition:0},17).wait(8));
...
if (reversed == null) { reversed = false; }
	...
	// wheels
	this.instance = new lib.wheelleft();
	this.instance.setTransform(1056.1,526.15,0.8548,1,0,0,0,32.6,37.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(292).to({_off:false},0).to({rotation:-90,x:983.15,y:527.4},16).to({regX:32.5,rotation:-149.9996,x:896.15,y:526},15).to({rotation:-209.9989,x:817.05,y:526.65},19).to({rotation:-254.9985,x:737,y:526.15},17).wait(31));
...
(lib.Scene_1_surfboart_start = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(537.05,398.1,1,1,0,0,0,78.1,293.9);

	this.start = new lib.start();
	this.start.name = "start";
	this.start.setTransform(704.2,232.6,1,1,0,0,0,69,45.5);
...
}).prototype = getMCSymbolPrototype(lib.Scene_1_surfboart_start, null, null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(277).to({_off:false},0).to({regY:130.1,scaleY:0.6926,rotation:60.0002,y:40.2},33).to({rotation:104.9988,x:1011.75,y:40.25},28).to({regY:130,rotation:179.9987,x:1011.8,y:40.2},19).to({regY:130.2,scaleY:0.6927,rotation:0,y:40.15},27).to({regY:130.1,scaleY:0.6926,rotation:60.0002,y:40.2},33).to({rotation:104.9988,x:1011.75,y:40.25},28).to({regY:130,rotation:179.9987,x:1011.8,y:40.2},19).to({regY:130.2,scaleY:0.6927,rotation:0,y:40.15},27).to({regY:130.1,scaleY:0.6926,rotation:60.0002,y:40.2},33).to({rotation:104.9988,x:1011.75,y:40.25},24).to({startPosition:5},9).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(724.2,313.35);
	this.instance_1._off = true;

	this.instance_2 = new lib.Tween53("synched",0);
	this.instance_2.setTransform(898.25,207.3);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween54("synched",0);
	this.instance_3.setTransform(1068.3,160.05);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({_off:true,x:724.2,y:313.35},34).wait(103));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},34).to({_off:true,x:898.25,y:207.3},34).wait(69));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(35).to({_off:false},34).to({_off:true,x:1068.3,y:160.05},30).wait(39));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(69).to({_off:false},30).to({startPosition:5},38).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(273).to({_off:false},0).wait(285));
...
if (reversed == null) { reversed = false; }
	...
	this.replay.setTransform(910.3,197.4,1,1,0,0,0,73.1,44.1);
	this.replay._off = true;
	new cjs.ButtonHelper(this.replay, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.replay).wait(557).to({_off:false},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// girl_copy
	this.instance = new lib.ילדה("synched",0);
...
if (reversed == null) { reversed = false; }
	...
	// flowers
	this.instance = new lib.פרח("synched",0);
	this.instance.setTransform(122,491.6,1,1,0,0,0,26,37.8);

	this.instance_1 = new lib.פרח("synched",0);
	this.instance_1.setTransform(1095.25,486.7,1,1,0,0,0,26,37.8);

	this.instance_2 = new lib.פרח("synched",0);
	this.instance_2.setTransform(341.05,462.55,1,1,0,0,0,26,37.8);

	this.instance_3 = new lib.פרח("synched",0);
	this.instance_3.setTransform(665.15,430.55,1,1,0,0,0,26,37.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},1).wait(137));
...
(lib.Scene_1_car_part2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(453).to({_off:false},0).to({x:1119.3},13).to({x:977.3},10).to({x:844.3},15).to({x:737.3},14).wait(25));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.instance}]},505).wait(53));
...
if (reversed == null) { reversed = false; }
	...
	// car
	this.instance = new lib.car2();
	this.instance.setTransform(1155.25,449.05,0.7552,0.7552,0,0,0,237.1,89.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(292).to({_off:false},0).to({x:1083.25},16).to({x:997.25},15).to({x:918.25},19).to({x:839.25},17).wait(31));
...
if (reversed == null) { reversed = false; }
	...
	// boy_car
	this.instance = new lib.ילד("synched",0);
	this.instance.setTransform(1118.1,459.4,0.5588,0.4921,0,0,0,53.8,90.7);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(292).to({_off:false},0).to({x:1043.1,startPosition:4},16).to({x:957.1,startPosition:9},15).to({x:879.1,startPosition:13},19).to({x:802.1,startPosition:17},17).to({startPosition:19},26).wait(5));
...
if (reversed == null) { reversed = false; }
	...
	// boy
	this.instance = new lib.ילד("synched",0);
	this.instance.setTransform(630.4,480.45,2.2362,2.2362,0,0,0,54.2,90.7);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(3,1,1).p("ABuAAQAAAtggAhQghAggtAAQgtAAggggQggghAAgtQAAgtAgggQAgggAtAAQAtAAAhAgQAgAgAAAtg");
	this.shape.setTransform(711.2,271.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(3,1,1).p("AEdiGQAAA8gqAqQgrAqg8AAQg8AAgqgqQgqgqAAg8QAAg8AqgrQAqgqA8AAQA8AAArAqQAqArAAA8gAhACqQAAAtghAhQggAggtAAQguAAggggQggghAAgtQAAguAgggQAgggAuAAQAtAAAgAgQAhAgAAAug");
	this.shape_1.setTransform(728.7,254.1);

	this.instance_1 = new lib.waves();
	this.instance_1.setTransform(811.55,130.2,0.1913,0.3095,0,0,0,675.6,114);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(3,1,1).p("AzxukQVcorNzI2QNzI2nZItQhoAwhoAqQ0lIVyvoLQn8p4I3pagAo/MZQAAA8grAqQgqArg8AAQg8AAgrgrQgqgqAAg8QAAg8AqgrQArgqA8AAQA8AAAqAqQArArAAA8gAudRKQAAAtghAgQggAhgtAAQguAAggghQggggAAgtQAAguAgggQAgggAuAAQAtAAAgAgQAhAgAAAug");
	this.shape_2.setTransform(814.8478,161.3304);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(255,204,51,0.2)").s().p("A0aBfIAAi9MAo0AAAIAAC9g");
	this.shape_3.setTransform(810.25,177.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{startPosition:0}}]},138).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:7}}]},65).to({state:[{t:this.shape_1},{t:this.instance,p:{startPosition:8}}]},6).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.instance,p:{startPosition:9}},{t:this.instance_1}]},6).wait(58));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(277).to({_off:false},0).to({_off:true,x:827.85,y:136.85},33).wait(47).to({_off:false,x:842.85,y:161.85},27).to({_off:true,x:827.85,y:136.85},33).wait(47).to({_off:false,x:842.85,y:161.85},27).to({_off:true,x:827.85,y:136.85},33).wait(34));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(277).to({_off:false},33).to({_off:true,x:793.9,y:145},28).wait(46).to({_off:false,x:827.85,y:136.85},33).to({_off:true,x:793.9,y:145},28).wait(46).to({_off:false,x:827.85,y:136.85},33).to({_off:true,x:793.9,y:145},24).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(310).to({_off:false},28).to({_off:true,x:752.1,y:102.75},19).wait(60).to({_off:false,x:793.9,y:145},28).to({_off:true,x:752.1,y:102.75},19).wait(60).to({_off:false,x:793.9,y:145},24).to({startPosition:0},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(338).to({_off:false},19).to({_off:true,x:842.85,y:161.85},27).wait(61).to({_off:false,x:752.1,y:102.75},19).to({_off:true,x:842.85,y:161.85},27).wait(67));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape},{t:this.instance}]},273).to({state:[{t:this.shape},{t:this.instance}]},34).to({state:[{t:this.shape},{t:this.instance}]},244).wait(7));
...
(lib.ילד2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:54.4,x:54.4},0).wait(2).to({_off:true},1).wait(27));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(3).to({_off:true},1).wait(9).to({_off:false},0).wait(3).to({_off:true},1).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(12).to({_off:false},0).wait(3).to({_off:true},1).wait(9).to({_off:false},0).wait(3).to({_off:true},1).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.3,0,111.5,196.9);
...
if (reversed == null) { reversed = false; }
	...
	// boy3
	this.instance = new lib.ילד2("synched",0);
	this.instance.setTransform(963.1,379.7,1.7951,1.7951,0,0,0,54.8,98.1);
	this.instance._off = true;
...
if (reversed == null) { reversed = false; }
	...
	// boy2_car
	this.instance = new lib.ילד2("synched",0);
	this.instance.setTransform(1213.7,458,0.5616,0.47,0,0,0,54.4,98.3);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(292).to({_off:false},0).to({x:1136.7,startPosition:4},16).to({x:1046.7,startPosition:9},15).to({x:969.7,startPosition:13},19).to({x:891.7,startPosition:17},17).to({startPosition:19},26).wait(5));
...
if (reversed == null) { reversed = false; }
	...
	// boy2
	this.instance = new lib.ילד2("synched",0);
	this.instance.setTransform(374.35,366.5,1.6587,1.6587,0,0,0,54.6,98.2);
	this.instance._off = true;
...
if (reversed == null) { reversed = false; }
	...
	// timeline functions:
	this.frame_0 = function() {
		this.start = this.surfboart_start.start;
		var self=this;
		self.stop();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(556).call(this.frame_557).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.___camera___instance).wait(203).to({scaleX:0.7975,scaleY:0.7975},0).wait(6).to({regX:0.1,regY:0.1,scaleX:0.6514,scaleY:0.6514,x:689.5,y:281.8},0).wait(6).to({regX:0.5,regY:0.6,scaleX:0.4304,scaleY:0.4304,x:786.7,y:151.45},0).wait(58).to({regX:1.1,regY:1.2,scaleX:0.9839,scaleY:0.9839,x:647.15,y:331.7},0).wait(88).to({regX:1.2,regY:1.3,scaleX:0.7201,scaleY:0.7201,x:526.95,y:331.65},0).wait(8).to({regX:1.6,regY:1.7,scaleX:0.6162,scaleY:0.6162,x:419.55,y:310.8},0).wait(7).to({regX:2.5,regY:2.4,scaleX:0.5137,scaleY:0.5137,x:433.45,y:204.9},0).wait(40).to({regX:2.6,regY:2.5,scaleX:0.5482,scaleY:0.5482,x:571.65,y:201.6},0).wait(37).to({regX:2.7,regY:2.6,scaleX:0.5789,scaleY:0.5789,x:739.4,y:197.35},0).wait(22).to({regX:2.8,regY:2.7,scaleX:0.5788,scaleY:0.5788,x:807.7,y:196.2},0).wait(83));
	...
	this.timeline.addTween(cjs.Tween.get(this.play_again).wait(557).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.birds).wait(277).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(80).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},27).to({regX:219.3,regY:2.9,scaleX:1.8243,scaleY:1.8243,x:-0.1,y:0.05},33).wait(28).to({regX:367.4,regY:-12.5,scaleX:1.7275,scaleY:1.7275,x:0.1,y:-0.05},19).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05,y:0},27).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.sun2).wait(277).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(80).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},27).to({regX:219.3,regY:2.9,scaleX:1.8243,scaleY:1.8243,x:-0.1,y:0.05},33).wait(28).to({regX:367.4,regY:-12.5,scaleX:1.7275,scaleY:1.7275,x:0.1,y:-0.05},19).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05,y:0},27).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.wheels2).wait(292).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(67).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},26).to({_off:true},5).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.wheels).wait(292).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(67).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},26).to({_off:true},5).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.car).wait(292).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(67).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},26).to({_off:true},5).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.boy2_car).wait(292).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(67).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},26).to({_off:true},5).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.boy_car).wait(292).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(67).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468},26).to({_off:true},5).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.girl_copy).wait(376).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468,x:0.05},0).to({_off:true},125).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.girl).wait(376).to({regX:103.4,regY:18.7,scaleX:1.9468,scaleY:1.9468,x:0.05},0).to({_off:true},125).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.wheels_part2).wait(453).to({regX:367.4,regY:-12.5,scaleX:1.7275,scaleY:1.7275,x:0.1,y:-0.05},0).wait(13).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05,y:0},10).wait(46).to({_off:true},8).wait(28));

	// car_part2_obj_
	this.car_part2 = new lib.Scene_1_car_part2();
	this.car_part2.name = "car_part2";
	this.car_part2.depth = 0;
	this.car_part2.isAttachedToCamera = 0
	this.car_part2.isAttachedToMask = 0
	this.car_part2.layerDepth = 0
	this.car_part2.layerIndex = 11
	this.car_part2.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.car_part2).wait(453).to({regX:367.4,regY:-12.5,scaleX:1.7275,scaleY:1.7275,x:0.1,y:-0.05},0).wait(13).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05,y:0},10).wait(46).to({_off:true},8).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.car_end).wait(505).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05},0).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.surfboard_end).wait(505).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276,x:0.05},0).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.beach).wait(273).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(278).to({regX:435.6,regY:-13.7,scaleX:1.7276,scaleY:1.7276},0).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.road).wait(273).to({regX:16.4,regY:-23.6,scaleX:1.0164,scaleY:1.0164,x:0.05},0).wait(285));
	...
	this.timeline.addTween(cjs.Tween.get(this.boy3).wait(173).to({_off:true},100).wait(285));
	...
	this.timeline.addTween(cjs.Tween.get(this.boy2).wait(154).to({_off:true},119).wait(285));
	...
	this.timeline.addTween(cjs.Tween.get(this.boy).wait(203).to({regX:129.6,regY:72.9,scaleX:1.2539,scaleY:1.2539},0).wait(6).to({regX:272.5,regY:47.2,scaleX:1.5351,scaleY:1.5351},0).wait(6).to({regX:511,regY:-3.8,scaleX:2.3233,scaleY:2.3233,y:-0.15},0).to({_off:true},58).wait(285));
	...
	this.flowers.layerIndex = 19
	this.flowers.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.flowers).wait(1).to({_off:true},137).wait(420));
	...
	this.grass.layerIndex = 20
	this.grass.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.grass).wait(1).to({_off:true},137).wait(420));
	...
	this.sun.layerIndex = 21
	this.sun.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.sun).wait(137).to({_off:true},1).wait(420));

	// surfboart_start_obj_
	this.surfboart_start = new lib.Scene_1_surfboart_start();
	this.surfboart_start.name = "surfboart_start";
	this.surfboart_start.setTransform(615.8,398.1,1,1,0,0,0,615.8,398.1);
	this.surfboart_start.depth = 0;
	this.surfboart_start.isAttachedToCamera = 0
	this.surfboart_start.isAttachedToMask = 0
	this.surfboart_start.layerDepth = 0
	this.surfboart_start.layerIndex = 22
	this.surfboart_start.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.surfboart_start).to({_off:true},1).wait(557));

	// waves_start_obj_
	this.waves_start = new lib.Scene_1_waves_start();
	this.waves_start.name = "waves_start";
	this.waves_start.setTransform(649.1,536.1,1,1,0,0,0,649.1,536.1);
	...
	this.waves_start.layerIndex = 23
	this.waves_start.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.waves_start).to({_off:true},1).wait(557));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(574.5,302.2,833.5999999999999,419.00000000000006);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/אנימציה_atlas_1.png?1617904307553", id:"אנימציה_atlas_1"},
		{src:"sounds/מיקיואליגלשןשירקיץילדיםשיריילדותישראליתmp3cutnet.mp3?1617904307676", id:"מיקיואליגלשןשירקיץילדיםשיריילדותישראליתmp3cutnet"}
	],
	preloads: []
};
